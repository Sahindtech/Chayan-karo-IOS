...
Widget _buildCategoryGrid() {
  final categories = [
     ...
     {'title': 'Dry Servicing','image': 'assets/ac_uninstallation.png',},
     {'title': 'Gas Refill','image': 'assets/ac_repair.png',},
     {'title': 'Repair & Checkup','image': 'assets/ac_services.png',},
  ];
...
Widget _buildBottomBar() {
 ...
 Widget _buildServiceCards() {
  final Map<String, List<Map<String, String>>> groupedServices = {
    'AC Installation': [
    {
      'image': 'assets/ac_installation.jpg',
  ...
  'AC Uninstallation': [
    {
      'image': 'assets/ac_uninstallation.png',
